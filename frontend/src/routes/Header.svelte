<script>
    import {Icon,ButtonDropdown, Dropdown, DropdownItem,DropdownMenu,DropdownToggle,Nav,NavItem,NavLink,} from "sveltestrap";
    let isOpen = false;
</script>

<div class="header-wrapper">
    <h2>SOS2223-<span class="accent-color">jul-vse</span></h2>
